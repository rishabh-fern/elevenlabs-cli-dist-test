...
pub enum MusicStreamRequestOutputFormat {
    Auto,
    Mp348000128,
    Mp348000192,
    Mp348000240,
...
impl Serialize for MusicStreamRequestOutputFormat {
...
impl<'de> Deserialize<'de> for MusicStreamRequestOutputFormat {
...
impl fmt::Display for MusicStreamRequestOutputFormat {
