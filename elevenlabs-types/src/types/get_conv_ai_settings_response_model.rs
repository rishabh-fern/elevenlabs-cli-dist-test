...
pub struct GetConvAiSettingsResponseModel {
...
impl GetConvAiSettingsResponseModel {
    pub fn builder() -> GetConvAiSettingsResponseModelBuilder {
        <GetConvAiSettingsResponseModelBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GetConvAiSettingsResponseModelBuilder {
...
impl GetConvAiSettingsResponseModelBuilder {
    ...
    /// Consumes the builder and constructs a [`GetConvAiSettingsResponseModel`].
    pub fn build(self) -> Result<GetConvAiSettingsResponseModel, BuildError> {
        Ok(GetConvAiSettingsResponseModel {
