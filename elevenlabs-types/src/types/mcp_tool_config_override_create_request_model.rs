...
pub struct McpToolConfigOverrideCreateRequestModel {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tool_call_sound: Option<McpToolConfigOverrideCreateRequestModelToolCallSound>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub input_overrides: Option<HashMap<String, Option<McpToolConfigOverrideCreateRequestModelInputOverridesValue>>>,
...
impl McpToolConfigOverrideCreateRequestModel {
    pub fn builder() -> McpToolConfigOverrideCreateRequestModelBuilder {
        <McpToolConfigOverrideCreateRequestModelBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct McpToolConfigOverrideCreateRequestModelBuilder {
    ...
    tool_call_sound: Option<McpToolConfigOverrideCreateRequestModelToolCallSound>,
    ...
    input_overrides: Option<HashMap<String, Option<McpToolConfigOverrideCreateRequestModelInputOverridesValue>>>,
    response_mocks: Option<Vec<ToolResponseMockConfigInput>>,
    tool_name: Option<String>,
    environment: Option<String>,
}

impl McpToolConfigOverrideCreateRequestModelBuilder {
    ...
    pub fn tool_call_sound(mut self, value: McpToolConfigOverrideCreateRequestModelToolCallSound) -> Self {
    ...
    pub fn input_overrides(mut self, value: HashMap<String, Option<McpToolConfigOverrideCreateRequestModelInputOverridesValue>>) -> Self {
    ...
    /// Consumes the builder and constructs a [`McpToolConfigOverrideCreateRequestModel`].
    /// This method will fail if any of the following fields are not set:
    /// - [`tool_name`](McpToolConfigOverrideCreateRequestModelBuilder::tool_name)
    pub fn build(self) -> Result<McpToolConfigOverrideCreateRequestModel, BuildError> {
        Ok(McpToolConfigOverrideCreateRequestModel {
