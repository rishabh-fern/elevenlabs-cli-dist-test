...
pub struct StreamTextToSpeechWithTimestampsRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub apply_text_normalization: Option<BodyTextToSpeechStreamWithTimestampsApplyTextNormalization>,
    ...
    #[serde(skip)]
    pub output_format: Option<TextToSpeechStreamWithTimestampsRequestOutputFormat>,
}

impl StreamTextToSpeechWithTimestampsRequest {
    pub fn builder() -> StreamTextToSpeechWithTimestampsRequestBuilder {
        <StreamTextToSpeechWithTimestampsRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct StreamTextToSpeechWithTimestampsRequestBuilder {
    text: Option<String>,
    ...
    apply_text_normalization: Option<BodyTextToSpeechStreamWithTimestampsApplyTextNormalization>,
    apply_language_text_normalization: Option<bool>,
    enable_logging: Option<bool>,
    optimize_streaming_latency: Option<i64>,
    output_format: Option<TextToSpeechStreamWithTimestampsRequestOutputFormat>,
}

impl StreamTextToSpeechWithTimestampsRequestBuilder {
    ...
    pub fn apply_text_normalization(mut self, value: BodyTextToSpeechStreamWithTimestampsApplyTextNormalization) -> Self {
    ...
    pub fn output_format(mut self, value: TextToSpeechStreamWithTimestampsRequestOutputFormat) -> Self {
        self.output_format = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`StreamTextToSpeechWithTimestampsRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`text`](StreamTextToSpeechWithTimestampsRequestBuilder::text)
    pub fn build(self) -> Result<StreamTextToSpeechWithTimestampsRequest, BuildError> {
        Ok(StreamTextToSpeechWithTimestampsRequest {
