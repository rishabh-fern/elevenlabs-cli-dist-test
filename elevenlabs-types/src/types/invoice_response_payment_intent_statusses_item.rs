...
pub enum InvoiceResponsePaymentIntentStatussesItem {
    Canceled,
    Processing,
    RequiresAction,
    RequiresCapture,
...
impl Serialize for InvoiceResponsePaymentIntentStatussesItem {
...
impl<'de> Deserialize<'de> for InvoiceResponsePaymentIntentStatussesItem {
...
impl fmt::Display for InvoiceResponsePaymentIntentStatussesItem {
