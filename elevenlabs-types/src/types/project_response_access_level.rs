...
pub enum ProjectResponseAccessLevel {
    Admin,
    Editor,
    Commenter,
    Viewer,
...
impl Serialize for ProjectResponseAccessLevel {
...
impl<'de> Deserialize<'de> for ProjectResponseAccessLevel {
...
impl fmt::Display for ProjectResponseAccessLevel {
