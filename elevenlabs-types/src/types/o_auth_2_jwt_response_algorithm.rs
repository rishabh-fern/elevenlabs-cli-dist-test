...
pub enum OAuth2JwtResponseAlgorithm {
    Hs256,
    Hs384,
    Hs512,
    Rs256,
...
impl Serialize for OAuth2JwtResponseAlgorithm {
...
impl<'de> Deserialize<'de> for OAuth2JwtResponseAlgorithm {
...
impl fmt::Display for OAuth2JwtResponseAlgorithm {
