...
impl LlmInfoModelInput {
    pub fn builder() -> LlmInfoModelInputBuilder {
        <LlmInfoModelInputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct LlmInfoModelInputBuilder {
    llm: Option<Llm>,
...
impl LlmInfoModelInputBuilder {
    ...
    /// Consumes the builder and constructs a [`LlmInfoModelInput`].
    /// This method will fail if any of the following fields are not set:
    /// - [`llm`](LlmInfoModelInputBuilder::llm)
    /// - [`is_checkpoint`](LlmInfoModelInputBuilder::is_checkpoint)
    /// - [`max_tokens_limit`](LlmInfoModelInputBuilder::max_tokens_limit)
    /// - [`max_context_limit`](LlmInfoModelInputBuilder::max_context_limit)
    /// - [`supports_image_input`](LlmInfoModelInputBuilder::supports_image_input)
    /// - [`supports_document_input`](LlmInfoModelInputBuilder::supports_document_input)
    /// - [`supports_parallel_tool_calls`](LlmInfoModelInputBuilder::supports_parallel_tool_calls)
    pub fn build(self) -> Result<LlmInfoModelInput, BuildError> {
        Ok(LlmInfoModelInput {
