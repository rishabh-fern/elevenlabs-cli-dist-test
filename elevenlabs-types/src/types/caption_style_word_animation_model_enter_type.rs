...
pub enum CaptionStyleWordAnimationModelEnterType {
    None,
    Fade,
    Scale,
    Pop,
...
impl Serialize for CaptionStyleWordAnimationModelEnterType {
...
impl<'de> Deserialize<'de> for CaptionStyleWordAnimationModelEnterType {
...
impl fmt::Display for CaptionStyleWordAnimationModelEnterType {
