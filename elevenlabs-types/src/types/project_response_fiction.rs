...
pub enum ProjectResponseFiction {
    Fiction,
    NonFiction,
...
impl Serialize for ProjectResponseFiction {
...
impl<'de> Deserialize<'de> for ProjectResponseFiction {
...
impl fmt::Display for ProjectResponseFiction {
