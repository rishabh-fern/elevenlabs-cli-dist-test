...
pub struct SystemToolConfigOutput {
    /// The type of tool
    ...
    pub params: SystemToolConfigOutputParams,
}

impl SystemToolConfigOutput {
    pub fn builder() -> SystemToolConfigOutputBuilder {
        <SystemToolConfigOutputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct SystemToolConfigOutputBuilder {
    ...
    params: Option<SystemToolConfigOutputParams>,
}

impl SystemToolConfigOutputBuilder {
    ...
    pub fn params(mut self, value: SystemToolConfigOutputParams) -> Self {
        self.params = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`SystemToolConfigOutput`].
    /// This method will fail if any of the following fields are not set:
    /// - [`name`](SystemToolConfigOutputBuilder::name)
    /// - [`params`](SystemToolConfigOutputBuilder::params)
    pub fn build(self) -> Result<SystemToolConfigOutput, BuildError> {
        Ok(SystemToolConfigOutput {
            r#type: self.r#type,
