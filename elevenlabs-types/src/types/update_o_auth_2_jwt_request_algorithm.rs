...
pub enum UpdateOAuth2JwtRequestAlgorithm {
    Hs256,
    Hs384,
    Hs512,
    Rs256,
...
impl Serialize for UpdateOAuth2JwtRequestAlgorithm {
...
impl<'de> Deserialize<'de> for UpdateOAuth2JwtRequestAlgorithm {
...
impl fmt::Display for UpdateOAuth2JwtRequestAlgorithm {
