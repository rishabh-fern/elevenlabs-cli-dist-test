...
#[serde(untagged)]
pub enum WebhookToolApiSchemaConfigInputRequestHeadersValue {
        String(String),
...
impl WebhookToolApiSchemaConfigInputRequestHeadersValue {
...
impl fmt::Display for WebhookToolApiSchemaConfigInputRequestHeadersValue {
