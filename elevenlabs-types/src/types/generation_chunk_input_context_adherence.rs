...
pub enum GenerationChunkInputContextAdherence {
    Low,
    Medium,
    High,
...
impl Serialize for GenerationChunkInputContextAdherence {
...
impl<'de> Deserialize<'de> for GenerationChunkInputContextAdherence {
...
impl fmt::Display for GenerationChunkInputContextAdherence {
