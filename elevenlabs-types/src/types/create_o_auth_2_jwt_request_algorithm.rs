...
pub enum CreateOAuth2JwtRequestAlgorithm {
    Hs256,
    Hs384,
    Hs512,
    Rs256,
...
impl Serialize for CreateOAuth2JwtRequestAlgorithm {
...
impl<'de> Deserialize<'de> for CreateOAuth2JwtRequestAlgorithm {
...
impl fmt::Display for CreateOAuth2JwtRequestAlgorithm {
