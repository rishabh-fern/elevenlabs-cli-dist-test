...
pub struct BackgroundSoundConfigWorkflowOverride {
...
impl BackgroundSoundConfigWorkflowOverride {
    pub fn builder() -> BackgroundSoundConfigWorkflowOverrideBuilder {
        <BackgroundSoundConfigWorkflowOverrideBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BackgroundSoundConfigWorkflowOverrideBuilder {
...
impl BackgroundSoundConfigWorkflowOverrideBuilder {
    ...
    /// Consumes the builder and constructs a [`BackgroundSoundConfigWorkflowOverride`].
    pub fn build(self) -> Result<BackgroundSoundConfigWorkflowOverride, BuildError> {
        Ok(BackgroundSoundConfigWorkflowOverride {
