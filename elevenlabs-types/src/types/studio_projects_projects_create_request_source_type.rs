...
pub enum ProjectsCreateRequestSourceType {
    Blank,
    Book,
    Article,
    Genfm,
...
impl Serialize for ProjectsCreateRequestSourceType {
...
impl<'de> Deserialize<'de> for ProjectsCreateRequestSourceType {
...
impl fmt::Display for ProjectsCreateRequestSourceType {
