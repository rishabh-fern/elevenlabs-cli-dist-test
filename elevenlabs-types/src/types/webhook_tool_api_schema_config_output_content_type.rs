...
pub enum WebhookToolApiSchemaConfigOutputContentType {
    ApplicationJson,
...
impl Serialize for WebhookToolApiSchemaConfigOutputContentType {
...
impl<'de> Deserialize<'de> for WebhookToolApiSchemaConfigOutputContentType {
...
impl fmt::Display for WebhookToolApiSchemaConfigOutputContentType {
