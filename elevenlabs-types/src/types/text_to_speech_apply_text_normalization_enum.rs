...
pub enum TextToSpeechApplyTextNormalizationEnum {
    Auto,
    On,
    Off,
...
impl Serialize for TextToSpeechApplyTextNormalizationEnum {
...
impl<'de> Deserialize<'de> for TextToSpeechApplyTextNormalizationEnum {
...
impl fmt::Display for TextToSpeechApplyTextNormalizationEnum {
