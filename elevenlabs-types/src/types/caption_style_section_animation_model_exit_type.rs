...
pub enum CaptionStyleSectionAnimationModelExitType {
    None,
    Fade,
    Scale,
    Pop,
...
impl Serialize for CaptionStyleSectionAnimationModelExitType {
...
impl<'de> Deserialize<'de> for CaptionStyleSectionAnimationModelExitType {
...
impl fmt::Display for CaptionStyleSectionAnimationModelExitType {
