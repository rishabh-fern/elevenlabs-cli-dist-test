...
pub struct ArrayJsonSchemaPropertyInput {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub constant_value: Option<Vec<ArrayJsonSchemaPropertyInputConstantValueItem>>,
...
pub struct ArrayJsonSchemaPropertyInputBuilder {
    ...
    constant_value: Option<Vec<ArrayJsonSchemaPropertyInputConstantValueItem>>,
...
impl ArrayJsonSchemaPropertyInputBuilder {
    ...
    pub fn constant_value(mut self, value: Vec<ArrayJsonSchemaPropertyInputConstantValueItem>) -> Self {
