...
pub struct McpToolConfigOverrideInput {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tool_call_sound: Option<McpToolConfigOverrideInputToolCallSound>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub input_overrides: Option<HashMap<String, Option<McpToolConfigOverrideInputInputOverridesValue>>>,
    /// Mock responses with optional parameter conditions. Evaluated top-to-bottom; first match wins.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub response_mocks: Option<Vec<ToolResponseMockConfigInput>>,
}

impl McpToolConfigOverrideInput {
    pub fn builder() -> McpToolConfigOverrideInputBuilder {
        <McpToolConfigOverrideInputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct McpToolConfigOverrideInputBuilder {
    ...
    tool_call_sound: Option<McpToolConfigOverrideInputToolCallSound>,
    ...
    input_overrides: Option<HashMap<String, Option<McpToolConfigOverrideInputInputOverridesValue>>>,
    response_mocks: Option<Vec<ToolResponseMockConfigInput>>,
}

impl McpToolConfigOverrideInputBuilder {
    ...
    pub fn tool_call_sound(mut self, value: McpToolConfigOverrideInputToolCallSound) -> Self {
    ...
    pub fn input_overrides(mut self, value: HashMap<String, Option<McpToolConfigOverrideInputInputOverridesValue>>) -> Self {
    ...
    /// Consumes the builder and constructs a [`McpToolConfigOverrideInput`].
    /// This method will fail if any of the following fields are not set:
    /// - [`tool_name`](McpToolConfigOverrideInputBuilder::tool_name)
    pub fn build(self) -> Result<McpToolConfigOverrideInput, BuildError> {
        Ok(McpToolConfigOverrideInput {
