...
pub enum VoiceSharingResponseCategory {
    Generated,
    Cloned,
    Premade,
    Professional,
...
impl Serialize for VoiceSharingResponseCategory {
...
impl<'de> Deserialize<'de> for VoiceSharingResponseCategory {
...
impl fmt::Display for VoiceSharingResponseCategory {
