...
pub struct PromptAgentApiModelOverrideOutput {
...
impl PromptAgentApiModelOverrideOutput {
    pub fn builder() -> PromptAgentApiModelOverrideOutputBuilder {
        <PromptAgentApiModelOverrideOutputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PromptAgentApiModelOverrideOutputBuilder {
...
impl PromptAgentApiModelOverrideOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`PromptAgentApiModelOverrideOutput`].
    pub fn build(self) -> Result<PromptAgentApiModelOverrideOutput, BuildError> {
        Ok(PromptAgentApiModelOverrideOutput {
            prompt: self.prompt,
            llm: self.llm,
