...
pub enum TextToSpeechConvertRequestOutputFormat {
    Alaw8000,
    Mp32205032,
    Mp32400048,
    Mp344100128,
...
impl Serialize for TextToSpeechConvertRequestOutputFormat {
...
impl<'de> Deserialize<'de> for TextToSpeechConvertRequestOutputFormat {
...
impl fmt::Display for TextToSpeechConvertRequestOutputFormat {
