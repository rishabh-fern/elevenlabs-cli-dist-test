...
pub struct AsrConversationalConfig {
...
impl AsrConversationalConfig {
    pub fn builder() -> AsrConversationalConfigBuilder {
        <AsrConversationalConfigBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AsrConversationalConfigBuilder {
...
impl AsrConversationalConfigBuilder {
    ...
    /// Consumes the builder and constructs a [`AsrConversationalConfig`].
    pub fn build(self) -> Result<AsrConversationalConfig, BuildError> {
        Ok(AsrConversationalConfig {
