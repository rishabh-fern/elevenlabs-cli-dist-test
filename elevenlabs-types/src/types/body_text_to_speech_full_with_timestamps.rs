...
pub struct BodyTextToSpeechFullWithTimestamps {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub apply_text_normalization: Option<BodyTextToSpeechFullWithTimestampsApplyTextNormalization>,
    ...
    #[serde(skip)]
    pub output_format: Option<TextToSpeechConvertWithTimestampsRequestOutputFormat>,
}

impl BodyTextToSpeechFullWithTimestamps {
    pub fn builder() -> BodyTextToSpeechFullWithTimestampsBuilder {
        <BodyTextToSpeechFullWithTimestampsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BodyTextToSpeechFullWithTimestampsBuilder {
    text: Option<String>,
    ...
    apply_text_normalization: Option<BodyTextToSpeechFullWithTimestampsApplyTextNormalization>,
    apply_language_text_normalization: Option<bool>,
    enable_logging: Option<bool>,
    optimize_streaming_latency: Option<i64>,
    output_format: Option<TextToSpeechConvertWithTimestampsRequestOutputFormat>,
}

impl BodyTextToSpeechFullWithTimestampsBuilder {
    ...
    pub fn apply_text_normalization(mut self, value: BodyTextToSpeechFullWithTimestampsApplyTextNormalization) -> Self {
    ...
    pub fn output_format(mut self, value: TextToSpeechConvertWithTimestampsRequestOutputFormat) -> Self {
        self.output_format = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`BodyTextToSpeechFullWithTimestamps`].
    /// This method will fail if any of the following fields are not set:
    /// - [`text`](BodyTextToSpeechFullWithTimestampsBuilder::text)
    pub fn build(self) -> Result<BodyTextToSpeechFullWithTimestamps, BuildError> {
        Ok(BodyTextToSpeechFullWithTimestamps {
