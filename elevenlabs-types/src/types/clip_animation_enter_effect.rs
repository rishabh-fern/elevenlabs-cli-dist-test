...
pub enum ClipAnimationEnterEffect {
    None,
    Fade,
    Float,
    GentleFloat,
...
impl Serialize for ClipAnimationEnterEffect {
...
impl<'de> Deserialize<'de> for ClipAnimationEnterEffect {
...
impl fmt::Display for ClipAnimationEnterEffect {
