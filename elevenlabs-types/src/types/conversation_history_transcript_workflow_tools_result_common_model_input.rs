...
pub struct ConversationHistoryTranscriptWorkflowToolsResultCommonModelInput {
    #[serde(default)]
    ...
    pub r#type: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub result: Option<Box<WorkflowToolResponseModelInput>>,
}

impl ConversationHistoryTranscriptWorkflowToolsResultCommonModelInput {
    pub fn builder() -> ConversationHistoryTranscriptWorkflowToolsResultCommonModelInputBuilder {
        <ConversationHistoryTranscriptWorkflowToolsResultCommonModelInputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ConversationHistoryTranscriptWorkflowToolsResultCommonModelInputBuilder {
    ...
    result: Option<Box<WorkflowToolResponseModelInput>>,
}

impl ConversationHistoryTranscriptWorkflowToolsResultCommonModelInputBuilder {
    ...
    pub fn result(mut self, value: Box<WorkflowToolResponseModelInput>) -> Self {
        self.result = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`ConversationHistoryTranscriptWorkflowToolsResultCommonModelInput`].
    /// This method will fail if any of the following fields are not set:
    /// - [`request_id`](ConversationHistoryTranscriptWorkflowToolsResultCommonModelInputBuilder::request_id)
    /// - [`tool_name`](ConversationHistoryTranscriptWorkflowToolsResultCommonModelInputBuilder::tool_name)
    /// - [`result_value`](ConversationHistoryTranscriptWorkflowToolsResultCommonModelInputBuilder::result_value)
    /// - [`is_error`](ConversationHistoryTranscriptWorkflowToolsResultCommonModelInputBuilder::is_error)
    /// - [`tool_has_been_called`](ConversationHistoryTranscriptWorkflowToolsResultCommonModelInputBuilder::tool_has_been_called)
    /// - [`r#type`](ConversationHistoryTranscriptWorkflowToolsResultCommonModelInputBuilder::r#type)
    pub fn build(self) -> Result<ConversationHistoryTranscriptWorkflowToolsResultCommonModelInput, BuildError> {
        Ok(ConversationHistoryTranscriptWorkflowToolsResultCommonModelInput {
