...
pub enum MusicComposeDetailedRequestOutputFormat {
    Auto,
    Mp348000128,
    Mp348000192,
    Mp348000240,
...
impl Serialize for MusicComposeDetailedRequestOutputFormat {
...
impl<'de> Deserialize<'de> for MusicComposeDetailedRequestOutputFormat {
...
impl fmt::Display for MusicComposeDetailedRequestOutputFormat {
