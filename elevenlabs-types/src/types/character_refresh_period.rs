...
pub enum CharacterRefreshPeriod {
    MonthlyPeriod,
    ThreeMonthPeriod,
    SixMonthPeriod,
    AnnualPeriod,
...
impl Serialize for CharacterRefreshPeriod {
...
impl<'de> Deserialize<'de> for CharacterRefreshPeriod {
...
impl fmt::Display for CharacterRefreshPeriod {
