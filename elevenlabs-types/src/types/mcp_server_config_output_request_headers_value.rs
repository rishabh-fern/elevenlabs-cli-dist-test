...
#[serde(untagged)]
pub enum McpServerConfigOutputRequestHeadersValue {
        String(String),
...
impl McpServerConfigOutputRequestHeadersValue {
...
impl fmt::Display for McpServerConfigOutputRequestHeadersValue {
