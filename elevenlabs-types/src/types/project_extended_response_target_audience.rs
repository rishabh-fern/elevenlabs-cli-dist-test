...
pub enum ProjectExtendedResponseTargetAudience {
    Children,
    YoungAdult,
    Adult,
    AllAges,
...
impl Serialize for ProjectExtendedResponseTargetAudience {
...
impl<'de> Deserialize<'de> for ProjectExtendedResponseTargetAudience {
...
impl fmt::Display for ProjectExtendedResponseTargetAudience {
