...
pub enum TextToDialogueConvertWithTimestampsRequestOutputFormat {
    Alaw8000,
    Mp32205032,
    Mp32400048,
    Mp344100128,
...
impl Serialize for TextToDialogueConvertWithTimestampsRequestOutputFormat {
...
impl<'de> Deserialize<'de> for TextToDialogueConvertWithTimestampsRequestOutputFormat {
...
impl fmt::Display for TextToDialogueConvertWithTimestampsRequestOutputFormat {
