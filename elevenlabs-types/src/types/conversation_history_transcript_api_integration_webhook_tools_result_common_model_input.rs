...
pub struct ConversationHistoryTranscriptApiIntegrationWebhookToolsResultCommonModelInput {
    #[serde(default)]
...
impl ConversationHistoryTranscriptApiIntegrationWebhookToolsResultCommonModelInput {
    pub fn builder() -> ConversationHistoryTranscriptApiIntegrationWebhookToolsResultCommonModelInputBuilder {
        <ConversationHistoryTranscriptApiIntegrationWebhookToolsResultCommonModelInputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ConversationHistoryTranscriptApiIntegrationWebhookToolsResultCommonModelInputBuilder {
...
impl ConversationHistoryTranscriptApiIntegrationWebhookToolsResultCommonModelInputBuilder {
    ...
    /// Consumes the builder and constructs a [`ConversationHistoryTranscriptApiIntegrationWebhookToolsResultCommonModelInput`].
    /// This method will fail if any of the following fields are not set:
    /// - [`request_id`](ConversationHistoryTranscriptApiIntegrationWebhookToolsResultCommonModelInputBuilder::request_id)
    /// - [`tool_name`](ConversationHistoryTranscriptApiIntegrationWebhookToolsResultCommonModelInputBuilder::tool_name)
    /// - [`result_value`](ConversationHistoryTranscriptApiIntegrationWebhookToolsResultCommonModelInputBuilder::result_value)
    /// - [`is_error`](ConversationHistoryTranscriptApiIntegrationWebhookToolsResultCommonModelInputBuilder::is_error)
    /// - [`tool_has_been_called`](ConversationHistoryTranscriptApiIntegrationWebhookToolsResultCommonModelInputBuilder::tool_has_been_called)
    /// - [`r#type`](ConversationHistoryTranscriptApiIntegrationWebhookToolsResultCommonModelInputBuilder::r#type)
    pub fn build(self) -> Result<ConversationHistoryTranscriptApiIntegrationWebhookToolsResultCommonModelInput, BuildError> {
        Ok(ConversationHistoryTranscriptApiIntegrationWebhookToolsResultCommonModelInput {
