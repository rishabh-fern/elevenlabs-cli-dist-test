...
pub struct AgentConfigApiModelWorkflowOverrideOutput {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub dynamic_variables: Option<DynamicVariablesConfigWorkflowOverride>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub prompt: Option<PromptAgentApiModelWorkflowOverrideOutput>,
}

impl AgentConfigApiModelWorkflowOverrideOutput {
    pub fn builder() -> AgentConfigApiModelWorkflowOverrideOutputBuilder {
        <AgentConfigApiModelWorkflowOverrideOutputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AgentConfigApiModelWorkflowOverrideOutputBuilder {
    first_message: Option<String>,
    language: Option<String>,
    hinglish_mode: Option<bool>,
    dynamic_variables: Option<DynamicVariablesConfigWorkflowOverride>,
    ...
    prompt: Option<PromptAgentApiModelWorkflowOverrideOutput>,
}

impl AgentConfigApiModelWorkflowOverrideOutputBuilder {
    ...
    pub fn dynamic_variables(mut self, value: DynamicVariablesConfigWorkflowOverride) -> Self {
    ...
    pub fn prompt(mut self, value: PromptAgentApiModelWorkflowOverrideOutput) -> Self {
        self.prompt = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`AgentConfigApiModelWorkflowOverrideOutput`].
    pub fn build(self) -> Result<AgentConfigApiModelWorkflowOverrideOutput, BuildError> {
        Ok(AgentConfigApiModelWorkflowOverrideOutput {
