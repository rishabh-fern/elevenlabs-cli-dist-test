...
pub struct AgentConfigOverrideOutput {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub prompt: Option<PromptAgentApiModelOverrideOutput>,
}

impl AgentConfigOverrideOutput {
    pub fn builder() -> AgentConfigOverrideOutputBuilder {
        <AgentConfigOverrideOutputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AgentConfigOverrideOutputBuilder {
    first_message: Option<String>,
    language: Option<String>,
    max_conversation_duration_message: Option<String>,
    prompt: Option<PromptAgentApiModelOverrideOutput>,
}

impl AgentConfigOverrideOutputBuilder {
    ...
    pub fn prompt(mut self, value: PromptAgentApiModelOverrideOutput) -> Self {
        self.prompt = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`AgentConfigOverrideOutput`].
    pub fn build(self) -> Result<AgentConfigOverrideOutput, BuildError> {
        Ok(AgentConfigOverrideOutput {
