...
pub struct TextToDialogueWebsocketClientMessage {
...
impl TextToDialogueWebsocketClientMessage {
    pub fn builder() -> TextToDialogueWebsocketClientMessageBuilder {
        <TextToDialogueWebsocketClientMessageBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct TextToDialogueWebsocketClientMessageBuilder {
...
impl TextToDialogueWebsocketClientMessageBuilder {
    ...
    /// Consumes the builder and constructs a [`TextToDialogueWebsocketClientMessage`].
    pub fn build(self) -> Result<TextToDialogueWebsocketClientMessage, BuildError> {
        Ok(TextToDialogueWebsocketClientMessage {
            inputs: self.inputs,
            flush: self.flush,
