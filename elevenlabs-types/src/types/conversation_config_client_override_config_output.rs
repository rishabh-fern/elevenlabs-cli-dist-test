...
pub struct ConversationConfigClientOverrideConfigOutput {
...
impl ConversationConfigClientOverrideConfigOutput {
    pub fn builder() -> ConversationConfigClientOverrideConfigOutputBuilder {
        <ConversationConfigClientOverrideConfigOutputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ConversationConfigClientOverrideConfigOutputBuilder {
...
impl ConversationConfigClientOverrideConfigOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`ConversationConfigClientOverrideConfigOutput`].
    pub fn build(self) -> Result<ConversationConfigClientOverrideConfigOutput, BuildError> {
        Ok(ConversationConfigClientOverrideConfigOutput {
            asr: self.asr,
            turn: self.turn,
            tts: self.tts,
