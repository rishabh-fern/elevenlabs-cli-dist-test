...
pub enum ConversationsGetRequestFormat {
    Json,
    Opentelemetry,
...
impl Serialize for ConversationsGetRequestFormat {
...
impl<'de> Deserialize<'de> for ConversationsGetRequestFormat {
...
impl fmt::Display for ConversationsGetRequestFormat {
