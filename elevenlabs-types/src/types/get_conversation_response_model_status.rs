...
pub enum GetConversationResponseModelStatus {
    Initiated,
    InProgress,
    Processing,
    Done,
...
impl Serialize for GetConversationResponseModelStatus {
...
impl<'de> Deserialize<'de> for GetConversationResponseModelStatus {
...
impl fmt::Display for GetConversationResponseModelStatus {
