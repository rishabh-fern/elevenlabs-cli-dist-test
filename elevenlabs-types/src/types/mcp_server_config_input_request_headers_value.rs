...
#[serde(untagged)]
pub enum McpServerConfigInputRequestHeadersValue {
        String(String),
...
impl McpServerConfigInputRequestHeadersValue {
...
impl fmt::Display for McpServerConfigInputRequestHeadersValue {
