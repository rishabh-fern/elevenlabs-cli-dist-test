...
pub enum ProjectsCreateRequestFiction {
    Fiction,
    NonFiction,
...
impl Serialize for ProjectsCreateRequestFiction {
...
impl<'de> Deserialize<'de> for ProjectsCreateRequestFiction {
...
impl fmt::Display for ProjectsCreateRequestFiction {
