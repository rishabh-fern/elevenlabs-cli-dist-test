...
#[serde(untagged)]
pub enum BodyStreamComposedMusicV1MusicStreamPostCompositionPlan {
        MusicPrompt(MusicPrompt),

        CompositionPlan(CompositionPlan),
}

impl BodyStreamComposedMusicV1MusicStreamPostCompositionPlan {
...
impl fmt::Display for BodyStreamComposedMusicV1MusicStreamPostCompositionPlan {
