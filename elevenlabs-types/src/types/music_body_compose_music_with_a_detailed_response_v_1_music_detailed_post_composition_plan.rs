...
#[serde(untagged)]
pub enum BodyComposeMusicWithADetailedResponseV1MusicDetailedPostCompositionPlan {
        MusicPrompt(MusicPrompt),

        CompositionPlan(CompositionPlan),
}

impl BodyComposeMusicWithADetailedResponseV1MusicDetailedPostCompositionPlan {
...
impl fmt::Display for BodyComposeMusicWithADetailedResponseV1MusicDetailedPostCompositionPlan {
