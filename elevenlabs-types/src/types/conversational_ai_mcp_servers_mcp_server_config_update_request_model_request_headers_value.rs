...
#[serde(untagged)]
pub enum McpServerConfigUpdateRequestModelRequestHeadersValue {
        String(String),
...
impl McpServerConfigUpdateRequestModelRequestHeadersValue {
...
impl fmt::Display for McpServerConfigUpdateRequestModelRequestHeadersValue {
