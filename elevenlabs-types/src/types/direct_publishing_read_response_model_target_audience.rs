...
pub enum DirectPublishingReadResponseModelTargetAudience {
    Children,
    YoungAdult,
    Adult,
    AllAges,
...
impl Serialize for DirectPublishingReadResponseModelTargetAudience {
...
impl<'de> Deserialize<'de> for DirectPublishingReadResponseModelTargetAudience {
...
impl fmt::Display for DirectPublishingReadResponseModelTargetAudience {
