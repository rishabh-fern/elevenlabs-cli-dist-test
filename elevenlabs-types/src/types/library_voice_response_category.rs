...
pub enum LibraryVoiceResponseCategory {
    Generated,
    Cloned,
    Premade,
    Professional,
...
impl Serialize for LibraryVoiceResponseCategory {
...
impl<'de> Deserialize<'de> for LibraryVoiceResponseCategory {
...
impl fmt::Display for LibraryVoiceResponseCategory {
