...
pub enum ResourceAccessInfoRole {
    Admin,
    Editor,
    Commenter,
    Viewer,
...
impl Serialize for ResourceAccessInfoRole {
...
impl<'de> Deserialize<'de> for ResourceAccessInfoRole {
...
impl fmt::Display for ResourceAccessInfoRole {
