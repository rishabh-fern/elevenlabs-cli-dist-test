...
pub enum TextToDialogueWebsocketOutputFormatEnum {
    Mp32205032,
    Mp32400048,
    Mp34410032,
    Mp34410064,
...
impl Serialize for TextToDialogueWebsocketOutputFormatEnum {
...
impl<'de> Deserialize<'de> for TextToDialogueWebsocketOutputFormatEnum {
...
impl fmt::Display for TextToDialogueWebsocketOutputFormatEnum {
