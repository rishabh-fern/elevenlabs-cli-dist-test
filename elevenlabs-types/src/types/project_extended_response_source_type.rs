...
pub enum ProjectExtendedResponseSourceType {
    Blank,
    Book,
    Article,
    Genfm,
...
impl Serialize for ProjectExtendedResponseSourceType {
...
impl<'de> Deserialize<'de> for ProjectExtendedResponseSourceType {
...
impl fmt::Display for ProjectExtendedResponseSourceType {
