...
pub enum CaptionStyleWordAnimationModelExitType {
    None,
    Fade,
    Scale,
    Pop,
...
impl Serialize for CaptionStyleWordAnimationModelExitType {
...
impl<'de> Deserialize<'de> for CaptionStyleWordAnimationModelExitType {
...
impl fmt::Display for CaptionStyleWordAnimationModelExitType {
