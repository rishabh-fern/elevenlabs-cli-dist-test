...
#[serde(untagged)]
pub enum WorkflowToolNestedToolsStepModelInputResultsItem {
        ...
        ConversationHistoryTranscriptWorkflowToolsResultCommonModelInput(Box<ConversationHistoryTranscriptWorkflowToolsResultCommonModelInput>),
}

impl WorkflowToolNestedToolsStepModelInputResultsItem {
    ...
    pub fn as_conversation_history_transcript_workflow_tools_result_common_model_input(&self) -> Option<&Box<ConversationHistoryTranscriptWorkflowToolsResultCommonModelInput>> {
        match self {
...
impl fmt::Display for WorkflowToolNestedToolsStepModelInputResultsItem {
