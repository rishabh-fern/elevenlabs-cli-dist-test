...
pub enum TextToDialogueConvertRequestOutputFormat {
    Alaw8000,
    Mp32205032,
    Mp32400048,
    Mp344100128,
...
impl Serialize for TextToDialogueConvertRequestOutputFormat {
...
impl<'de> Deserialize<'de> for TextToDialogueConvertRequestOutputFormat {
...
impl fmt::Display for TextToDialogueConvertRequestOutputFormat {
