...
pub enum ProjectExtendedResponseAccessLevel {
    Admin,
    Editor,
    Commenter,
    Viewer,
...
impl Serialize for ProjectExtendedResponseAccessLevel {
...
impl<'de> Deserialize<'de> for ProjectExtendedResponseAccessLevel {
...
impl fmt::Display for ProjectExtendedResponseAccessLevel {
