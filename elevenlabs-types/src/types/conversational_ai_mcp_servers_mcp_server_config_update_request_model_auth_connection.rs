...
#[serde(untagged)]
pub enum McpServerConfigUpdateRequestModelAuthConnection {
        AuthConnectionLocator(AuthConnectionLocator),

        EnvironmentAuthConnectionLocator(EnvironmentAuthConnectionLocator),
}

impl McpServerConfigUpdateRequestModelAuthConnection {
...
impl fmt::Display for McpServerConfigUpdateRequestModelAuthConnection {
