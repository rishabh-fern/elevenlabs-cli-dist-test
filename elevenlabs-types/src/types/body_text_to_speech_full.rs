...
pub struct BodyTextToSpeechFull {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub apply_text_normalization: Option<BodyTextToSpeechFullApplyTextNormalization>,
    ...
    #[serde(skip)]
    pub output_format: Option<TextToSpeechConvertRequestOutputFormat>,
}

impl BodyTextToSpeechFull {
    pub fn builder() -> BodyTextToSpeechFullBuilder {
        <BodyTextToSpeechFullBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BodyTextToSpeechFullBuilder {
    text: Option<String>,
    ...
    apply_text_normalization: Option<BodyTextToSpeechFullApplyTextNormalization>,
    apply_language_text_normalization: Option<bool>,
    enable_logging: Option<bool>,
    optimize_streaming_latency: Option<i64>,
    output_format: Option<TextToSpeechConvertRequestOutputFormat>,
}

impl BodyTextToSpeechFullBuilder {
    ...
    pub fn apply_text_normalization(mut self, value: BodyTextToSpeechFullApplyTextNormalization) -> Self {
    ...
    pub fn output_format(mut self, value: TextToSpeechConvertRequestOutputFormat) -> Self {
        self.output_format = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`BodyTextToSpeechFull`].
    /// This method will fail if any of the following fields are not set:
    /// - [`text`](BodyTextToSpeechFullBuilder::text)
    pub fn build(self) -> Result<BodyTextToSpeechFull, BuildError> {
        Ok(BodyTextToSpeechFull {
