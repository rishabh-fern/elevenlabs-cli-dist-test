...
#[serde(tag = "type")]
#[non_exhaustive]
pub enum BodyAddAPronunciationDictionaryV1PronunciationDictionariesAddFromRulesPostRulesItem {
        #[serde(rename = "alias")]
        #[non_exhaustive]
        Alias {
            #[serde(flatten)]
...
impl BodyAddAPronunciationDictionaryV1PronunciationDictionariesAddFromRulesPostRulesItem {
