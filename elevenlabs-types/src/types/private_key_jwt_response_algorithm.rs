...
pub enum PrivateKeyJwtResponseAlgorithm {
    Hs256,
    Hs384,
    Hs512,
    Rs256,
...
impl Serialize for PrivateKeyJwtResponseAlgorithm {
...
impl<'de> Deserialize<'de> for PrivateKeyJwtResponseAlgorithm {
...
impl fmt::Display for PrivateKeyJwtResponseAlgorithm {
