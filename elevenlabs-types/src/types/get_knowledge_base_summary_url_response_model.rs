...
pub struct GetKnowledgeBaseSummaryUrlResponseModel {
    #[serde(default)]
    pub id: String,
    #[serde(default)]
    pub name: String,
    ...
    #[serde(default)]
    pub dependent_agents: Vec<GetKnowledgeBaseSummaryUrlResponseModelDependentAgentsItem>,
    #[serde(default)]
    pub url: String,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl GetKnowledgeBaseSummaryUrlResponseModel {
    pub fn builder() -> GetKnowledgeBaseSummaryUrlResponseModelBuilder {
        <GetKnowledgeBaseSummaryUrlResponseModelBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GetKnowledgeBaseSummaryUrlResponseModelBuilder {
    id: Option<String>,
    name: Option<String>,
    ...
    dependent_agents: Option<Vec<GetKnowledgeBaseSummaryUrlResponseModelDependentAgentsItem>>,
    url: Option<String>,
    auto_sync_info: Option<AutoSyncInfo>,
}

impl GetKnowledgeBaseSummaryUrlResponseModelBuilder {
    ...
    pub fn dependent_agents(mut self, value: Vec<GetKnowledgeBaseSummaryUrlResponseModelDependentAgentsItem>) -> Self {
    ...
    /// Consumes the builder and constructs a [`GetKnowledgeBaseSummaryUrlResponseModel`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](GetKnowledgeBaseSummaryUrlResponseModelBuilder::id)
    /// - [`name`](GetKnowledgeBaseSummaryUrlResponseModelBuilder::name)
    /// - [`metadata`](GetKnowledgeBaseSummaryUrlResponseModelBuilder::metadata)
    /// - [`supported_usages`](GetKnowledgeBaseSummaryUrlResponseModelBuilder::supported_usages)
    /// - [`access_info`](GetKnowledgeBaseSummaryUrlResponseModelBuilder::access_info)
    /// - [`dependent_agents`](GetKnowledgeBaseSummaryUrlResponseModelBuilder::dependent_agents)
    /// - [`url`](GetKnowledgeBaseSummaryUrlResponseModelBuilder::url)
    pub fn build(self) -> Result<GetKnowledgeBaseSummaryUrlResponseModel, BuildError> {
        Ok(GetKnowledgeBaseSummaryUrlResponseModel {
