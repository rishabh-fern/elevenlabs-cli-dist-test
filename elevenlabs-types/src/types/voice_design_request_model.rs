...
impl VoiceDesignRequestModel {
    pub fn builder() -> VoiceDesignRequestModelBuilder {
        <VoiceDesignRequestModelBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct VoiceDesignRequestModelBuilder {
    voice_description: Option<String>,
    model_id: Option<VoiceDesignRequestModelModelId>,
    text: Option<String>,
...
impl VoiceDesignRequestModelBuilder {
    pub fn voice_description(mut self, value: impl Into<String>) -> Self {
        self.voice_description = Some(value.into());
        self
    }

    pub fn model_id(mut self, value: VoiceDesignRequestModelModelId) -> Self {
    ...
    pub fn reference_audio_base64(mut self, value: impl Into<String>) -> Self {
        self.reference_audio_base64 = Some(value.into());
        self
    }
    ...
    /// Consumes the builder and constructs a [`VoiceDesignRequestModel`].
    /// This method will fail if any of the following fields are not set:
    /// - [`voice_description`](VoiceDesignRequestModelBuilder::voice_description)
    pub fn build(self) -> Result<VoiceDesignRequestModel, BuildError> {
        Ok(VoiceDesignRequestModel {
