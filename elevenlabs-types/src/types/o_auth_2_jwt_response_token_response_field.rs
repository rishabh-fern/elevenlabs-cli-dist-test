...
pub enum OAuth2JwtResponseTokenResponseField {
    AccessToken,
    IdToken,
...
impl Serialize for OAuth2JwtResponseTokenResponseField {
...
impl<'de> Deserialize<'de> for OAuth2JwtResponseTokenResponseField {
...
impl fmt::Display for OAuth2JwtResponseTokenResponseField {
