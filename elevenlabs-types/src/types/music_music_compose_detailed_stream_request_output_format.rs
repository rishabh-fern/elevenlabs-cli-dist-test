...
pub enum MusicComposeDetailedStreamRequestOutputFormat {
    Auto,
    Mp348000128,
    Mp348000192,
    Mp348000240,
...
impl Serialize for MusicComposeDetailedStreamRequestOutputFormat {
...
impl<'de> Deserialize<'de> for MusicComposeDetailedStreamRequestOutputFormat {
...
impl fmt::Display for MusicComposeDetailedStreamRequestOutputFormat {
