...
pub struct ProjectResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub target_audience: Option<ProjectResponseTargetAudience>,
    ...
    pub access_level: ProjectResponseAccessLevel,
    /// Whether the project is fiction.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub fiction: Option<ProjectResponseFiction>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub source_type: Option<ProjectResponseSourceType>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub aspect_ratio: Option<ProjectResponseAspectRatio>,
...
pub struct ProjectResponseBuilder {
    ...
    target_audience: Option<ProjectResponseTargetAudience>,
    ...
    access_level: Option<ProjectResponseAccessLevel>,
    fiction: Option<ProjectResponseFiction>,
    ...
    source_type: Option<ProjectResponseSourceType>,
    ...
    aspect_ratio: Option<ProjectResponseAspectRatio>,
...
impl ProjectResponseBuilder {
    ...
    pub fn target_audience(mut self, value: ProjectResponseTargetAudience) -> Self {
    ...
    pub fn access_level(mut self, value: ProjectResponseAccessLevel) -> Self {
        self.access_level = Some(value);
        self
    }

    pub fn fiction(mut self, value: ProjectResponseFiction) -> Self {
    ...
    pub fn source_type(mut self, value: ProjectResponseSourceType) -> Self {
    ...
    pub fn aspect_ratio(mut self, value: ProjectResponseAspectRatio) -> Self {
    ...
    /// - [`create_date_unix`](ProjectResponseBuilder::create_date_unix)
    /// - [`default_title_voice_ref_id`](ProjectResponseBuilder::default_title_voice_ref_id)
    /// - [`default_paragraph_voice_ref_id`](ProjectResponseBuilder::default_paragraph_voice_ref_id)
    /// - [`default_model_id`](ProjectResponseBuilder::default_model_id)
    /// - [`can_be_downloaded`](ProjectResponseBuilder::can_be_downloaded)
    /// - [`volume_normalization`](ProjectResponseBuilder::volume_normalization)
    /// - [`state`](ProjectResponseBuilder::state)
    /// - [`access_level`](ProjectResponseBuilder::access_level)
    /// - [`quality_check_on`](ProjectResponseBuilder::quality_check_on)
    /// - [`quality_check_on_when_bulk_convert`](ProjectResponseBuilder::quality_check_on_when_bulk_convert)
