...
pub struct AgentConfigApiModelWorkflowOverrideInput {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub prompt: Option<PromptAgentApiModelWorkflowOverrideInput>,
}

impl AgentConfigApiModelWorkflowOverrideInput {
    pub fn builder() -> AgentConfigApiModelWorkflowOverrideInputBuilder {
        <AgentConfigApiModelWorkflowOverrideInputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AgentConfigApiModelWorkflowOverrideInputBuilder {
    ...
    prompt: Option<PromptAgentApiModelWorkflowOverrideInput>,
}

impl AgentConfigApiModelWorkflowOverrideInputBuilder {
    ...
    pub fn prompt(mut self, value: PromptAgentApiModelWorkflowOverrideInput) -> Self {
        self.prompt = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`AgentConfigApiModelWorkflowOverrideInput`].
    pub fn build(self) -> Result<AgentConfigApiModelWorkflowOverrideInput, BuildError> {
        Ok(AgentConfigApiModelWorkflowOverrideInput {
