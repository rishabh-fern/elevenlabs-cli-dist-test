...
pub struct PrivacyConfigOutput {
...
impl PrivacyConfigOutput {
    pub fn builder() -> PrivacyConfigOutputBuilder {
        <PrivacyConfigOutputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PrivacyConfigOutputBuilder {
...
impl PrivacyConfigOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`PrivacyConfigOutput`].
    pub fn build(self) -> Result<PrivacyConfigOutput, BuildError> {
        Ok(PrivacyConfigOutput {
