...
pub enum ProjectsCreateRequestTargetAudience {
    Children,
    YoungAdult,
    Adult,
    AllAges,
...
impl Serialize for ProjectsCreateRequestTargetAudience {
...
impl<'de> Deserialize<'de> for ProjectsCreateRequestTargetAudience {
...
impl fmt::Display for ProjectsCreateRequestTargetAudience {
