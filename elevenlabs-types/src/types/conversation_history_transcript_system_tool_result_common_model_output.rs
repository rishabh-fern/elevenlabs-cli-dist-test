...
pub struct ConversationHistoryTranscriptSystemToolResultCommonModelOutput {
    #[serde(default)]
    ...
    pub r#type: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub result: Option<ConversationHistoryTranscriptSystemToolResultCommonModelOutputResult>,
}

impl ConversationHistoryTranscriptSystemToolResultCommonModelOutput {
    pub fn builder() -> ConversationHistoryTranscriptSystemToolResultCommonModelOutputBuilder {
        <ConversationHistoryTranscriptSystemToolResultCommonModelOutputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ConversationHistoryTranscriptSystemToolResultCommonModelOutputBuilder {
    ...
    result: Option<ConversationHistoryTranscriptSystemToolResultCommonModelOutputResult>,
}

impl ConversationHistoryTranscriptSystemToolResultCommonModelOutputBuilder {
    ...
    pub fn result(mut self, value: ConversationHistoryTranscriptSystemToolResultCommonModelOutputResult) -> Self {
        self.result = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`ConversationHistoryTranscriptSystemToolResultCommonModelOutput`].
    /// This method will fail if any of the following fields are not set:
    /// - [`request_id`](ConversationHistoryTranscriptSystemToolResultCommonModelOutputBuilder::request_id)
    /// - [`tool_name`](ConversationHistoryTranscriptSystemToolResultCommonModelOutputBuilder::tool_name)
    /// - [`result_value`](ConversationHistoryTranscriptSystemToolResultCommonModelOutputBuilder::result_value)
    /// - [`is_error`](ConversationHistoryTranscriptSystemToolResultCommonModelOutputBuilder::is_error)
    /// - [`tool_has_been_called`](ConversationHistoryTranscriptSystemToolResultCommonModelOutputBuilder::tool_has_been_called)
    /// - [`r#type`](ConversationHistoryTranscriptSystemToolResultCommonModelOutputBuilder::r#type)
    pub fn build(self) -> Result<ConversationHistoryTranscriptSystemToolResultCommonModelOutput, BuildError> {
        Ok(ConversationHistoryTranscriptSystemToolResultCommonModelOutput {
