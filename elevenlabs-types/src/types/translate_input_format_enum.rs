...
pub enum TranslateInputFormatEnum {
    Pcm8000,
    Pcm16000,
    Pcm22050,
    Pcm24000,
...
impl Serialize for TranslateInputFormatEnum {
...
impl<'de> Deserialize<'de> for TranslateInputFormatEnum {
...
impl fmt::Display for TranslateInputFormatEnum {
