...
pub struct ClientToolConfigOutput {
    #[serde(default)]
    pub name: String,
...
impl ClientToolConfigOutput {
    pub fn builder() -> ClientToolConfigOutputBuilder {
        <ClientToolConfigOutputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ClientToolConfigOutputBuilder {
    name: Option<String>,
...
impl ClientToolConfigOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`ClientToolConfigOutput`].
    /// This method will fail if any of the following fields are not set:
    /// - [`name`](ClientToolConfigOutputBuilder::name)
    /// - [`description`](ClientToolConfigOutputBuilder::description)
    pub fn build(self) -> Result<ClientToolConfigOutput, BuildError> {
        Ok(ClientToolConfigOutput {
