...
pub struct StreamRequest2 {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub file_format: Option<SpeechToSpeechStreamRequestFileFormat>,
    #[serde(skip)]
    pub enable_logging: Option<bool>,
    #[serde(skip)]
    pub optimize_streaming_latency: Option<i64>,
    #[serde(skip)]
    pub output_format: Option<SpeechToSpeechStreamRequestOutputFormat>,
}
impl StreamRequest2 {
...
impl StreamRequest2 {
    pub fn builder() -> StreamRequest2Builder {
        <StreamRequest2Builder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct StreamRequest2Builder {
    audio: Option<Vec<u8>>,
    model_id: Option<String>,
    voice_settings: Option<String>,
    seed: Option<i64>,
    remove_background_noise: Option<bool>,
    file_format: Option<SpeechToSpeechStreamRequestFileFormat>,
    enable_logging: Option<bool>,
    optimize_streaming_latency: Option<i64>,
    output_format: Option<SpeechToSpeechStreamRequestOutputFormat>,
}

impl StreamRequest2Builder {
    ...
    pub fn file_format(mut self, value: SpeechToSpeechStreamRequestFileFormat) -> Self {
    ...
    pub fn output_format(mut self, value: SpeechToSpeechStreamRequestOutputFormat) -> Self {
        self.output_format = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`StreamRequest2`].
    /// This method will fail if any of the following fields are not set:
    /// - [`audio`](StreamRequest2Builder::audio)
    pub fn build(self) -> Result<StreamRequest2, BuildError> {
        Ok(StreamRequest2 {
