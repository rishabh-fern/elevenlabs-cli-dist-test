...
pub enum TranscriptsGetRequestFormatType {
    Srt,
    Webvtt,
    Json,
...
impl Serialize for TranscriptsGetRequestFormatType {
...
impl<'de> Deserialize<'de> for TranscriptsGetRequestFormatType {
...
impl fmt::Display for TranscriptsGetRequestFormatType {
