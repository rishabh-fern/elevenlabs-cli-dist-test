...
pub enum MusicComposeRequestOutputFormat {
    Auto,
    Mp348000128,
    Mp348000192,
    Mp348000240,
...
impl Serialize for MusicComposeRequestOutputFormat {
...
impl<'de> Deserialize<'de> for MusicComposeRequestOutputFormat {
...
impl fmt::Display for MusicComposeRequestOutputFormat {
